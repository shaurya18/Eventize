            ...
            <div class="container">
                <div class="row">
                    ...
                    <ul class="product-list-vertical">
                        <h2>All Events</h2>
                        <%List<Eventrequest> admin_events = (List<Eventrequest>) session.getAttribute("admin_event_list");
    for (Eventrequest e : admin_events) {%>
                        <li>
                            ...
                            <div class="product-details">
                                ...
                                <form action="UpdateStatusByAdminServlet" method = "POST">
                                    <input type ="hidden" value="<%=e.getEId()%>" name="update_status">
                                    <button>Update Status!</button>
                                </form>
                                <form action="DeleteEventByAdminServlet" method = "POST">
                                    <input type ="hidden" value="<%=e.getEId()%>" name="delete_event">
